...
\centering
\subfloat[]{%
  \centering\includegraphics[width=0.5\columnwidth]{flight_outliers_none_nb_MultinomialNB_best_recall_eval.png}%
}
\subfloat[]{%
  \centering\includegraphics[width=0.5\columnwidth]{flight_outliers_none_knn_KNN_best_recall_eval.png}%
}
...
\begin{figure}[H]
\subfloat[]{%
  \centering\includegraphics[width=0.5\columnwidth]{flight_Standard-Scaler_nb_vs_knn_performance.png}%
}
\subfloat[]{%
  \centering\includegraphics[width=0.5\columnwidth]{flight_MinMax-Scaler_knn_KNN_best_recall_eval.png}%
}
